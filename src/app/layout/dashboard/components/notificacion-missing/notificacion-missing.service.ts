...
@Injectable({
  ...
  export class NotificacionMissignService {
    ...
    getCitasByConsultorioMissing( id: string ) {
      const params = new HttpParams()
      .set('id', id);
    return this.http.get(`${this.url}/citas/byConsultorioMissing`, {headers: this.headers, params: params});
  }
